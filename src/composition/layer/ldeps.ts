...
interface PerformMap {
	onPropertyValueChange: {
		[propertyId: string]: Performable[];
	};
	onGraphNodeValueChange: {
		[nodeId: string]: Performable[];
	};
	onContainerSizeChange: Performable[];
	onFrameIndexChange: Performable[];
}
...
interface UpdateUpstreamNodes {
	graphId: string;
	nodeId: string;
}

type Performable = UpdateUpstreamNodes | RecomputeProperty;
