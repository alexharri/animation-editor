...
export const dragProjectCompWorkspaceToArea = (e: React.MouseEvent, options: Options) => {
	...
	requestAction({ history: false }, (params) => {
		...
		const initialState: CompositionWorkspaceAreaState = {
			...areaInitialStates[AreaType.CompositionWorkspace],
			compositionId,
		};
		...
		addListener.once("mouseup", () => {
			...
			dispatch(areaActions.setAreaType(areaId, AreaType.CompositionWorkspace, initialState));
